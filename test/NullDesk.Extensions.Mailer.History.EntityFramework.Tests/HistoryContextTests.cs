...
{
    public class HistoryContextTests : IClassFixture<NullMailMemoryEfFixture>
    {
        private const string Subject = "xunit Test run: no template - history";

        private NullMailMemoryEfFixture Fixture { get; }

        public HistoryContextTests(NullMailMemoryEfFixture fixture)
        {
            Fixture = fixture;
        }
