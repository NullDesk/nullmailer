...
namespace NullDesk.Extensions.Mailer.Core
{
    ...
    public interface IMailerFactory
    {
        ...
        void Register<T>(Func<T> mailerFunc) where T : class, ISimpleMailer;
        ...
        /// <returns>T.</returns>
        T GetMailer<T>() where T : class, ISimpleMailer;
    }
}