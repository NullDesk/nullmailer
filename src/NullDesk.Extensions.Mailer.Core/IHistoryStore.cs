...
namespace NullDesk.Extensions.Mailer.Core
{
    ...
    public interface IHistoryStore
    {
        ...
        /// <param name="token">The token.</param>
        /// <returns>Task&lt;HistoryItem&gt;.</returns>
        Task<IEnumerable<MessageDeliveryItem>> GetAsync(int offset = 0, int limit = 100, CancellationToken token = default(CancellationToken));
        ...
        /// <param name="token">The token.</param>
        /// <returns>Task&lt;HistoryItem&gt;.</returns>
        Task<IEnumerable<MessageDeliveryItem>> SearchAsync(string searchText, int limit = 100, CancellationToken token = default(CancellationToken));
