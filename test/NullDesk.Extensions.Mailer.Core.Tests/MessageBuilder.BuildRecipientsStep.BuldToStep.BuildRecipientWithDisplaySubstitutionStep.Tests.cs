...
{
    public class BuildRecipientWithDisplaySubstitutionStepTests
    {
        [Theory]
        ...
        [Trait("TestType", "Unit")]
        public void BuildRecipientWithDisplaySubstitutionStep_WithPersonalizedSubstitution(string address, string token, string value)
        {
